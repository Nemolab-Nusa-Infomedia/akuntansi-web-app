...
const cardsData = [
  {
    subtitle: "Masalah Umum Bimbel",
    problem: "Operasional",
    image: "/../../assets/problem.png",
    alt: "problem",
    cardTitle: "Masalah Biaya Operasional Bimbel",
    description:
  ...
  },
  {
    ...
    alt: "problem",
    cardTitle: "Pengelolaan Aset yang Rumit di Bimbel",
    description:
  ...
  },
  {
    ...
    alt: "problem",
    cardTitle: "Kesulitan dengan Laporan Keuangan Bimbel",
    description:
  ...
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        ...
        Belajar dengan Software Akuntansi Modern
      </h1>
      <p class="text-[#45434D] text-3xl mb-20 max-lg:mb-4 max-lg:text-xl">
        Software akuntansi modern mempermudah pengelolaan keuangan bimbingan
        belajar Anda dengan fitur yang intuitif. Nikmati kemudahan dalam
        pencatatan dan pelaporan keuangan yang lebih efisien.
      </p>
    ...
    >
      <div>
        ...
        >
          Revolusi Pengelolaan Keuangan Bimbingan Belajar Anda Sekarang dengan
    ...
    >
      <div class="text-center space-y-6 max-lg:space-y-3">
        <h1 class="text-5xl max-lg:text-2xl text-primary font-semibold">
          Masalah Umum dalam Keuangan Bimbingan Belajar
        </h1>
        <p class="text-2xl max-lg:text-lg text-[#45434D]">
          Banyak yayasan menghadapi masalah bimbel seperti pencatatan yang rumit
          dan laporan keuangan yang membingungkan. Jangan biarkan masalah ini
          menghambat efisiensi bimbel Anda, temukan solusinya sekarang sebelum
          terlambat!
        </p>
      </div>
