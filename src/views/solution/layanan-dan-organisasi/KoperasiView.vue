...
const cardsData = [
  {
    subtitle: "Masalah Umum Koperasi",
    problem: "Transaksi",
    image: "/../../assets/problem.png",
    alt: "problem",
    cardTitle: "Tantangan Manajemen Transaksi",
    description:
      "Mengelola transaksi yang rumit bisa mengganggu bisnis. Sistem manajemen transaksi mempermudah pencatatan.",
  },
  {
    subtitle: "Masalah Umum Koperasi",
    problem: "Keuangan",
    ...
    alt: "problem",
    cardTitle: "Masalah Pencatatan Keuangan",
    description:
      "Pencatatan keuangan yang tidak teratur menyebabkan kesalahan. Sistem pencatatan keuangan yang baik memastikan laporan.",
  },
  {
    subtitle: "Masalah Umum Koperasi",
    problem: "Aset",
    ...
    alt: "problem",
    cardTitle: "Kesulitan Pengelolaan Aset Koperasi",
    description:
      "Pengelolaan aset yang tidak efisien bisa menyebabkan pemborosan. Alat pengelolaan aset membantu mengoptimalkan penggunaan.",
  },
];
...
<template>
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        Optimalkan Pengelolaan Koperasi Anda dengan Pembukuan Efisien
        Menggunakan Software Akuntansi Kledo
      </h1>
      <p class="text-[#45434D] text-3xl mb-20 max-lg:mb-4 max-lg:text-xl">
        Software akuntansi Kledo mempermudah pengelolaan koperasi dengan
        pembukuan yang efisien. Nikmati kemudahan dan akurasi dalam mengelola
        keuangan koperasi Anda.
      </p>
    ...
    >
      <div>
        ...
        >
          Raih Pengelolaan Koperasi yang Sempurna dengan Pembukuan Efisien dari
          Kledo!
        </h2>
    ...
    >
      <div class="text-center space-y-6 max-lg:space-y-3">
        <h1 class="text-5xl max-lg:text-2xl text-primary font-semibold">
          Masalah Umum dalam Keuangan Koperasi
        </h1>
        <p class="text-2xl max-lg:text-lg text-[#45434D]">
          Banyak koperasi menghadapi masalah akuntansi seperti pencatatan yang
          rumit dan laporan keuangan yang membingungkan. Jangan biarkan masalah
          ini menghambat efisiensi koperasi Anda, temukan solusinya sekarang
          sebelum terlambat!
        </p>
      </div>
