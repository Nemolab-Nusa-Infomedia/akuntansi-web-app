...
const cardsData = [
  {
    subtitle: "Masalah Umum Klinik",
    problem: "Persediaan",
    image: "/../../assets/problem.png",
    alt: "problem",
    cardTitle: "Tantangan Memantau Persediaan di Klinik",
    description:
      "Memantau persediaan secara manual bisa membingungkan dan tidak akurat. Sistem manajemen mempermudah pelacakan stok.",
  },
  {
    subtitle: "Masalah Umum Klinik",
    problem: "Anggaran",
    ...
    alt: "problem",
    cardTitle: "Masalah Manajemen Anggaran di Klinik",
    description:
      "Mengelola anggaran yang tidak terstruktur bisa mengakibatkan pemborosan. Solusi manajemen anggaran yang efektif membantu optimal dana.",
  },
  {
    subtitle: "Masalah Umum Klinik",
    ...
    alt: "problem",
    cardTitle: "Kesulitan Membuat Laporan Keuangan di Klinik",
    description:
...
<template>
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        Kelola <span class="relative inline-block">
          Keuangan Klinik Anda
          <span
            class="absolute inset-7 -z-10 bg-[#FFC055] h-6 max-lg:hidden left-1/2 w-[530px] -translate-x-1/2 rounded-sm"
          ></span>
        </span>  Secara Efektif dengan Core Jurnal untuk
        Kesehatan Finansial yang Lebih Stabil
      </h1>
      <p class="text-[#45434D] text-3xl mb-20 max-lg:mb-4 max-lg:text-xl">
        Core Jurnal menyederhanakan pengelolaan akuntansi klinik Anda dengan
        fitur yang mudah digunakan. Atur keuangan Anda dengan efisien, sama
        mudahnya seperti mengelola jadwal harian.
      </p>
    ...
    >
      <div>
        ...
        >
          Temukan Cara Mudah Mengelola Keuangan Klinik Anda dengan Core Jurnal
        </h2>
    ...
    >
      <div class="text-center space-y-6 max-lg:space-y-3">
        <h1 class="text-5xl max-lg:text-2xl text-primary font-semibold">
          Masalah Umum dalam Keuangan Klinik
        </h1>
        <p class="text-2xl max-lg:text-lg text-[#45434D]">
          Banyak klinik menghadapi masalah akuntansi seperti pencatatan yang
          rumit dan laporan keuangan yang membingungkan. Jangan biarkan masalah
          ini menghambat efisiensi klinik Anda, temukan solusinya sekarang
          sebelum terlambat!
        </p>
      </div>
