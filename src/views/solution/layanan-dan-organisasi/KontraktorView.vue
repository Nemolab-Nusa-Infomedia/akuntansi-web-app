...
const cardsData = [
  {
    subtitle: "Masalah Umum Kontraktor",
    problem: "Aset",
    image: "/../../assets/problem.png",
    alt: "problem",
    cardTitle: "Masalah Pengelolaan Aset di Kontraktor",
    description:
  ...
  },
  {
    ...
    alt: "problem",
    cardTitle: "Tantangan Biaya Operasional di Kontraktor",
    description:
  ...
  },
  {
    ...
    alt: "problem",
    cardTitle: "Masalah Pengelolaan Laba di Bisnis",
    description:
      "Mengelola laba yang tidak tepat bisa menghambat pertumbuhan bisnis. Sistem akuntansi yang efektif membantu memantau.",
  },
];
...
<template>
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        Kelola Transaksi dan
        <span class="relative inline-block">
          Proyek Kontraktor
          <span
            class="absolute inset-7 -z-10 bg-[#FFC055] h-6 max-lg:hidden left-1/2 w-[430px] -translate-x-1/2 rounded-sm"
          ></span>
        </span>
        dengan Cepat Menggunakan Software Akuntansi Core Jurnal
      </h1>
      <p class="text-[#45434D] text-3xl mb-20 max-lg:mb-4 max-lg:text-xl">
        Dengan software akuntansi Core Jurnal, Anda dapat mengelola transaksi
        dan proyek kontraktor dengan cepat dan efisien. Fitur intuitif kami
        mempermudah pencatatan dan pengambilan keputusan proyek Anda.
      </p>
    ...
    >
      <div>
        ...
        >
          Raih Kecepatan dan Efisiensi dalam Mengelola Proyek Kontraktor dengan
          Core Jurnal!
        </h2>
    ...
    >
      <div class="text-center space-y-6 max-lg:space-y-3">
        <h1 class="text-5xl max-lg:text-2xl text-primary font-semibold">
          Masalah Umum dalam Bisnis Kontraktor
        </h1>
        <p class="text-2xl max-lg:text-lg text-[#45434D]">
          Banyak kontraktor menghadapi masalah akuntansi seperti pencatatan yang
          rumit dan laporan keuangan yang membingungkan. Jangan biarkan masalah
          ini menghambat efisiensi kontraktor Anda, temukan solusinya sekarang
          sebelum terlambat!
        </p>
      </div>
