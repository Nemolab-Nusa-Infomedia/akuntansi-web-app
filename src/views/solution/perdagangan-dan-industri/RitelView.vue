...
<template>
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        Solusi Akuntansi Terbaik untuk Mengelola Pembukuan Bisnis
        <span class="relative inline-block">
          Retail
          <span
            class="absolute inset-7 -z-10 bg-[#FFC055] h-6 max-lg:hidden left-1/2 w-[130px] -translate-x-1/2 rounded-sm"
          ></span>
        </span>
        Anda
      </h1>
