...
const cardsData = [
  {
    subtitle: "Masalah Umum Distibusi",
    problem: "Kurang Visabilitas",
    image: "/../../assets/problem.png",
    alt: "problem",
    cardTitle: "Keterbatasan Visibilitas Inventaris",
    description:
      "Tanpa visibilitas stok yang real-time, perusahaan bisa kehabisan produk yang dibutuhkan atau malah memiliki stok berlebih.",
  },
  {
    subtitle: "Masalah Umum Distibusi",
    ...
    alt: "problem",
    cardTitle: "Pengiriman Terlambat yang Menghambat Kepuasan",
    description:
      "Keterlambatan pengiriman sering terjadi karena kurangnya koordinasi antara tim logistik, masalah di rantai pasokan.",
  },
  {
    subtitle: "Masalah Umum Distibusi",
    problem: "Operasional",
    ...
    alt: "problem",
    cardTitle: "Operasional Tinggi yang Menggerus Keuntungan",
    description:
      "Biaya distribusi yang tidak dikelola dengan baik, seperti bahan bakar, penyimpanan, dan pengiriman, dapat meningkat tajam.",
  },
];
...
<template>
  <div class="py-28 max-lg:py-8">
    <div class="block px-28 max-lg:px-8 text-center pb-28 max-lg:pb-8">
      ...
      >
        Software Akuntansi yang Memudahkan dan Mengintegrasikan
        <span class="relative inline-block">
          Proses Distribusi
          <span
            class="absolute inset-7 -z-10 bg-[#FFC055] h-6 max-lg:hidden left-1/2 w-[400px] -translate-x-1/2 rounded-sm"
          ></span>
        </span>
      </h1>
      <p class="text-[#45434D] text-3xl mb-20 max-lg:mb-4 max-lg:text-xl">
        Software akuntansi ini menyederhanakan pengelolaan keuangan dan
        mengintegrasikan proses distribusi. Hemat waktu dan fokus pada
    ...
    >
      <div>
        ...
        >
          Hemat Waktu dan Maksimalkan Distribusi dengan Software Akuntansi
          Terintegrasi Ini!
        </h2>
    ...
    >
      <div class="text-center space-y-6 max-lg:space-y-3">
        <h1 class="text-5xl max-lg:text-2xl text-primary font-semibold">
          Masalah Umum pada Proses Distribusi
        </h1>
        <p class="text-2xl max-lg:text-lg text-[#45434D]">
          Masalah umum pada usaha dagang meliputi kesalahan pencatatan,
          pengelolaan inventaris yang buruk, dan laporan keuangan yang tidak
          terupdate. Mengatasi masalah ini penting untuk bisnis yang sehat dan
          efisien.
        </p>
      </div>
